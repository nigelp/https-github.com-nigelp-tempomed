...
const PostSession = ({
  ...
  return (
    <div className="w-full max-w-[500px] mx-auto bg-white rounded-xl shadow-lg p-2 sm:p-6">
      <Card className="mb-6">
        <div className="p-2 sm:p-4">
          ...
          {/* Step content */}
          <div className="min-h-[400px] sm:min-h-[450px] flex items-center justify-center">
            {renderStepContent()}
          </div>
          ...
          <div className="flex justify-between mt-8">
            <Button
              ...
              className="flex items-center gap-1 sm:gap-2 px-2 sm:px-4 whitespace-nowrap"
            >
